...
# desired_caps = {'platformName': 'Android','deviceName': 'instagram_2972','appPackage': 'com.instagram.android','appActivity': 'com.instagram.android.activity.MainTabActivity','automationName': 'UiAutomator2'}
    ...
    def open_chrome(self):
        ...
        if title :
            if title.text == 'Welcome to Chrome':
                accept_btn = self.find_element('accept & continue','//android.widget.Button[@resource-id="com.android.chrome:id/terms_accept"]')
                if accept_btn:
                    if accept_btn.text == 'Accept & continue':
                        accept_btn = self.click_element('accept & continue','//android.widget.Button[@resource-id="com.android.chrome:id/terms_accept"]')
        else :
            accept_btn = self.find_element('accept & continue','//android.widget.Button[@resource-id="com.android.chrome:id/terms_accept"]')
            if accept_btn:
                if accept_btn.text == 'Accept & continue':
        ...
        sign_title = self.find_element('sign in to chrome','com.android.chrome:id/chooser_title', By.ID)
        if sign_title :
